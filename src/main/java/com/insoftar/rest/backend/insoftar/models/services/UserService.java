...
public interface UserService {
    Page<UserDTO> findAll(Pageable pageable) throws RestException;

    UserDTO save(UserDTO userDTO) throws RestException;

    UserDTO findById(Long id) throws RestException;
