package com.insoftar.rest.backend.insoftar.config.constants;

/**
 * <h1>GeneralConstants</h1>
 * Constantes de uso general para el proyecto
 *
...
public class GeneralConstants {
    ...
    public static final String ID_NUMBER_ALREADY_EXIST_TEXT = "El número de identificación ya se encuentra en uso";
